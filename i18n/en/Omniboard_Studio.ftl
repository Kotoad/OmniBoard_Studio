...
code-editor-window-save-error = Error saving code: { $error_type }: { $error_message }
code-editor-window-file-not-found = File.py not found
...
settings-window-theme-tab-combo = Theme
settings-window-theme-tab-light-theme = Light theme
settings-window-theme-tab-dark-theme = Dark theme
settings-window-theme-tab-nord-theme = Nord theme
settings-window-theme-tab-dracula-theme = Dracula theme
settings-window-theme-tab-gruvbox-theme = Gruvbox theme
settings-window-theme-tab-solarized-dark-theme = Solarized dark theme
settings-window-theme-tab-solarized-light-theme = Solarized light theme
settings-window-theme-tab-monokai-theme = Monokai theme
settings-window-theme-tab-one-dark-theme = One Dark theme
settings-window-theme-tab-catppuccin-theme = Catppuccin theme
settings-window-theme-tab-custom-theme = Custom theme
settings-window-theme-tab-main-darker = Main darker color
settings-window-theme-tab-main = Main color
settings-window-theme-tab-main-lighter = Main lighter color
settings-window-theme-tab-text = Text color
settings-window-theme-tab-highlight = Highlight color
settings-window-theme-tab-highlight-text = Highlight text color
settings-window-theme-tab-warning = Warning color
settings-window-theme-tab-dark = Dark color
settings-window-theme-tab-shadow = Shadow color

# rpi_settings_tab
settings-window-rpi-settings-tab-title = Raspberry Pi Settings
settings-window-rpi-settings-tab-connection-method = Connection Method
settings-window-rpi-settings-tab-auto-detect = Auto-Detect Raspberry Pi
settings-window-rpi-settings-tab-manual-entry = Or enter manually
settings-window-rpi-settings-tab-status = Status
settings-window-rpi-settings-tab-status-not-connected = Status: Not connected
settings-window-rpi-settings-tab-status-not-detected = Status: No RPI detected
settings-window-rpi-settings-tab-status-error = Status: Error during detection
settings-window-rpi-settings-tab-status-incomplete = Status: Incomplete configuration
settings-window-rpi-settings-tab-status-connected =
    Status: Connected!
    Hostname: { $hostname }
    IP: { $ip }
    Model: { $model }
settings-window-rpi-settings-tab-rpi-host = Host/IP
settings-window-rpi-settings-tab-rpi-host-placeholder = raspberrypi.local or 192.168.1.100
settings-window-rpi-settings-tab-rpi-user = Username
settings-window-rpi-settings-tab-rpi-user-placeholder = pi
settings-window-rpi-settings-tab-rpi-password = Password
settings-window-rpi-settings-tab-rpi-password-placeholder = (optional if using SSH keys)
settings-window-rpi-settings-tab-toggle-password = Show/Hide Password
settings-window-rpi-settings-tab-unknown-hostname = Unknown hostname
settings-window-rpi-settings-tab-unknown-model = Unknown model

# dialogs.restart_dialog
settings-window-dialogs-restart-dialog-title = Restart Application
settings-window-dialogs-restart-dialog-message = Some changes require restarting the application to take effect. Do you want to restart now?

# dialogs.auto_detect_dialog
settings-window-dialogs-auto-detect-dialog-process = Detecting Raspberry Pi on network.
settings-window-dialogs-auto-detect-dialog-cancel = Cancel
settings-window-dialogs-auto-detect-dialog-detection-error-title = Detection Error
settings-window-dialogs-auto-detect-dialog-detection-error-message = Failed to detect Raspberry Pi on the network. Please check your network connection and try again.
settings-window-dialogs-auto-detect-dialog-fail-title = Detection Failed
settings-window-dialogs-auto-detect-dialog-fail-message =
    No Raspberry Pi found on the network.
     Please ensure your Raspberry Pi is powered on and connected to the same network or enter details manually.
settings-window-dialogs-auto-detect-dialog-invalid-result = Invalid result returned from detection
settings-window-dialogs-auto-detect-dialog-incomplete-error-title = Error
settings-window-dialogs-auto-detect-dialog-incomplete-error-message = Raspberry Pi detection returned incomplete data.
settings-window-dialogs-auto-detect-dialog-success-title = Detection Successful
