...
<body class="bg-slate-900 text-slate-100 font-sans antialiased min-h-screen flex flex-col">
    ...
    <main class="max-w-4xl mx-auto px-6 py-12 space-y-16 flex-grow">
        <section>
            ...
            <p class="text-slate-300 mb-4">Here are some of the key electrical and magnetic quantities you should be familiar with:</p>
                ...
                <li class="flex items-start gap-3">
                    ...
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50">
                        <li class="flex items-start gap-3">
                            ...
                            <span> A fundamental property of matter that causes it to experience a force when placed in an electric field, measured in coulombs (C) and represented by "Q".
                            In simple terms, it can be thought of as the "quantity" of electricity, where a higher charge indicates more electric particles present.</span> 
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric voltage</span>
                            <span>In electrical terms is a potential difference between two points in a circuit, measured in volts (V) and it's represented by the symbol "V" in American English and "U" in European English.
                            In simple terms, it can be thought of as the "pressure" that pushes electric charges through a conductor, enabling the flow of current.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric current</span>
                            <span>The flow of electric charge through a conductor, measured in amperes (A) and represented by "I".
                            It represents the rate at which electric charges pass through a point in a circuit.
                            There are two types of electric current: direct current (DC), where the flow of charge is in one direction, and alternating current (AC), where the flow of charge periodically reverses direction.
                            In simple terms, it can be thought of as the "flow" of electricity, where a higher current indicates a greater flow of electric charge.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric resistance</span>
                            <span>The opposition to the flow of electric current, measured in ohms (Ω) and represented by "R".
                            It determines how much current will flow for a given voltage, the rest will turn to heat.
                            In simple terms, it can be thought of as the "friction" that impedes the flow of electricity, where a higher resistance results in less current flow for a given voltage.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric power</span>
                            <span>The rate at which electrical energy is transferred or consumed, measured in watts (W) and represented by "P".
                            In simple terms, it can be thought of as the "work" done by electricity, where a higher power indicates more energy being transferred or consumed.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            In simple terms, it can be thought of as the "ease" with which electricity flows through a conductor, where a higher conductance indicates less resistance and easier flow of electric current.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric energy</span>
                            <span>The capacity to do work, measured in joules (J) and represented by "E".
                            In simple terms, it can be thought of as the "fuel" that powers electrical devices, where a higher energy indicates more capacity to perform work.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric capacity</span>
                            <span>The ability of a system to store electric charge, measured in farads (F) and represented by "C".
                            In simple terms, it can be thought of as the "storage" for electricity, where a higher capacity indicates a greater ability to store electric charge.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Electric inductance</span>
                            <span>The property of a conductor that opposes changes in current, measured in henries (H) and represented by "L".
                            In simple terms, it can be thought of as the "inertia" of electricity, where a higher inductance indicates a greater opposition to changes in current flow.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic flux</span>
                            <span>The total magnetic field passing through a given area, measured in webers (Wb) and represented by "Φ".
                            In simple terms, it can be thought of as the "amount" of magnetism, where a higher magnetic flux indicates a stronger magnetic field passing through an area.</span>
                        </li>
                    </ul>
                </li>
                <li class="flex items-start gap-3">
                    ...
                    <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            In simple terms, it can be thought of as the "strength" of magnetism, where a higher magnetic field strength indicates a stronger magnetic field.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic permeability</span>
                            <span>The ability of a material to support the formation of a magnetic field, measured in henries per meter (H/m) and represented by "μ".
                            In simple terms, it can be thought of as the "friendliness" of a material to magnetism, where a higher magnetic permeability indicates that the material allows magnetic fields to pass through it more easily.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic reluctance</span>
                            <span>The opposition to the creation of a magnetic field in a material, measured in ampere-turns per weber (At/Wb) and represented by "R_m".
                            In simple terms, it can be thought of as the "resistance" to magnetism, where a higher magnetic reluctance indicates that the material opposes the formation of a magnetic field more strongly.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic energy</span>
                            <span>The energy stored in a magnetic field, measured in joules (J) and represented by "E_m".
                            In simple terms, it can be thought of as the "potential" of magnetism, where a higher magnetic energy indicates that more energy is stored in the magnetic field.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic force</span>
                            <span>The force exerted by a magnetic field on moving charges or other magnets, measured in newtons (N) and represented by "F_m".
                            In simple terms, it can be thought of as the "push" or "pull" of magnetism, where a higher magnetic force indicates a stronger interaction between the magnetic field and charged particles or other magnets.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-500 mt-1">Magnetic moment</span>
                            <span>A measure of the strength and orientation of a magnet's magnetic field, measured in ampere-square meters (A·m²) and represented by "m".
                            In simple terms, it can be thought of as the "personality" of a magnet, where a higher magnetic moment indicates a stronger and more oriented magnetic field.</span>
                        </li>
                    </ul>
                </li>
        </section>
        ...
        <section>
            ...
            <ul class="space-y-4 text-slate-300 bg-slate-800/50 p-6 rounded-xl border border-slate-700/50">
                <li class="flex items-start gap-3">
                    ...
                    <span> A reference point in an electrical circuit from which voltages are measured, a common return path for electric current.
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>A component that resists the flow of electric current, used to control voltage and current in a circuit.
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>A component that stores and releases electrical energy, used for filtering, timing, and energy storage in circuits.
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>A component that stores energy in a magnetic field when electric current flows through it, used for filtering, energy storage, and inductive coupling in circuits.
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>A component that allows current to flow in one direction only, used for rectification, signal modulation, and protection in circuits.
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>A semiconductor device used to amplify or switch electronic signals, essential for building complex circuits and digital logic.
