...
<body class="bg-slate-900 text-slate-100 font-sans antialiased min-h-screen flex flex-col">
    ...
    <header class="max-w-5xl mx-auto px-6 py-20 text-center">
        <h1 class="text-5xl font-extrabold tracking-tight text-white mb-6">
            Visual Programming for Microcontrollers and Microcomputers
        </h1>
        <p class="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
            Build and compile MicroPython and Python projects seamlessly. A complete visual node environment with
            ...
            <div class="max-w-5xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        ...
                        <p class="text-slate-400">Drag and drop logic blocks, timers, and hardware interfaces to build
                            complex logic without writing syntax manually.</p>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        <h3 class="text-xl font-bold mb-3 text-blue-400">Integrated Compiler</h3>
                        <p class="text-slate-400">Instantly translate visual node graphs into optimized MicroPython and
                            Python code ready for deployment to connected devices.</p>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        <h3 class="text-xl font-bold mb-3 text-blue-400">Hardware Support</h3>
                        <p class="text-slate-400">Native support and setup workflows for the Raspberry Pi Pico series
                            and Raspberry Pi 1 to 5.</p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        ...
                        <p class="text-slate-400">Adding compatibility with more microcontroller platforms and
                            single-board computers beyond the Raspberry Pi ecosystem.</p>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        <h3 class="text-xl font-bold mb-3 text-blue-400">Advanced Node Types</h3>
                        <p class="text-slate-400">Introducing new node categories for more complex logic, data
                            processing, and hardware interactions.</p>
                    </div>
                    <div class="p-6 border border-slate-700 rounded-xl shadow-sm bg-slate-800">
                        <h3 class="text-xl font-bold mb-3 text-blue-400">Community Contributions</h3>
                        <p class="text-slate-400">Encouraging users to share their own node templates, tutorials, and
                            project ideas to foster a collaborative learning environment.</p>
                    </div>
                </div>
            </div>
        </section>
